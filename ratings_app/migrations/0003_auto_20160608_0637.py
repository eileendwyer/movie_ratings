# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-06-08 06:37
...
def movie_stat(apps, schema_editor):
    Movie = apps.get_model("ratings_app", "Movie")
    with open("u.item", encoding="latin1") as outfile:
        movie = csv.DictReader(outfile, fieldnames=["movie_id", "title", "release_date", "video_release",
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ratings_app', '0002_auto_20160608_0535'),
    ]

    operations = [
        migrations.RunPython(movie_stat)
    ]
